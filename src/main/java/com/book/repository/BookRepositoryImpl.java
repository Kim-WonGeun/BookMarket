...
public class BookRepositoryImpl implements BookRepository {
	...
	public BookRepositoryImpl() {
		...
		book1.setDescription(
								"C# 교과서는 생애 첫 프로그래밍 언어로 C#을 시작하는 독자를 대상으로 한다. 특히 "
								+ "응용 프로그래머를 위한 C# 입문서로, C#을 사용하여 게임(유니티), 웹, 모바일, IoT 등을 "
		...
		book2.setDescription(
								...
								+ "사용해 보면서 실제로 동작하는 서버를 만들어보자. 예제와 코드는 최신 문법을 사용했고 "
		...
		book3.setDescription(
								"어도비 XD 프로그램을 통해 UI/UX 디자인을 배우고자 하는 예비 디자이너의 눈높이에 맞게 "
								+ "기본적인 도구를 활용한 아이콘 디자인과 웹&앱 페에지 디자인, UI 디자인, 앱 디자인에 "
